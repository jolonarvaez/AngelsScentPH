                                            ...
                                            <tr :key="product.id" v-for="product in products" class="my-5">
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <button class="btn mb-2 text-uppercase btn save-btn btn-outline-light" @click="deleteProduct(product.id)" data-bs-toggle="modal" :data-bs-target='"#removeProduct"+product.id'>Delete</button>
                                                    </div>
